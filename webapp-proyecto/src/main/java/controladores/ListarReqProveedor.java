...
@WebServlet("/listarRequerimientosProveedor")
public class ListarReqProveedor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("usernameProv", usernameOptional);
        getServletContext().getRequestDispatcher("/listarRequerimientosProv.jsp").forward(req, resp);
